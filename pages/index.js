...
const PopupInputTitleElement = PopupElement.querySelector('.popup__form-title');
const PopupInputSubtitleElement = PopupElement.querySelector('.popup__form-subtitle');
