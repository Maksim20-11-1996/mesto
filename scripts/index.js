...
const popupInputTitleElement = popupElement.querySelector('.popup__profile_name');
const popupInputSubtitleElement = popupElement.querySelector('.popup__profile_job');
